...
## The algorithm
Suppose our sample is made by $\textbf{x_{1}}$ ... $\textbf{x_{n}}$ indipendent drowing from some p-dimentional population The algorithm starts searching for the **first principal component**, that is the coefficients of the linear compbination
