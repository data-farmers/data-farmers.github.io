...
## Cons
The conclusion may be reached from observing Figure 14.5,
where we saw that it is difficult to decide how many components to use. It is
not possible to explain a very high proportion of the total variance with a small
number of principal components. Also, the interpretation of the components
in Table 14.2 is not straightforward. This is frequently the case in real-life
situations. Occasionally, situations do come up in which the results are clearcut.
For examples of such situations, see Jolliffe (2010).
